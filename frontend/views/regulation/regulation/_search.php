...
<div class="regulation-search">
    ...
    $searchFields = array_merge(
        ...
        SearchFieldHelper::textField('numberBoard', 'Номер совета', 'Номер совета'),
        SearchFieldHelper::dropdownField('status', 'Статус положения', RegulationWork::states(), 'Состояние положения')
    );

    echo HtmlBuilder::createFilterPanel($searchModel, $searchFields, $form, 3, Yii::$app->frontUrls::REG_INDEX); ?>
